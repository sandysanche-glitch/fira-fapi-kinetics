...
def main():
    ...
    parser.add_argument("--out", type=Path, default=Path("main_video_bridge_panel_with_avrami_fonts.png"))
    ...
    ax_a.legend(frameon=False, loc="lower right", fontsize=legend_fs)
    ...
    ax_c.legend(frameon=False, loc="lower right", fontsize=11.5)
